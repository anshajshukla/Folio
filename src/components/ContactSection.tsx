...
function ContactSection() {
  ...
  return (
    <section id="contact" className="scroll-mt-[80px] py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="text-center mb-16">
          <h2 className="gradient-text text-4xl md:text-5xl lg:text-6xl font-bold mb-4">Contact Me</h2>
          <p className="text-gray-300 mt-2 max-w-2xl mx-auto text-lg">Let's discuss how we can work together</p>
        </div>

        <div className="mt-6">
          <motion.div
            ref={ref}
            className="grid sm:grid-cols-2 items-start gap-12 p-8 mx-auto max-w-5xl bg-slate-800 rounded-md"
          ...
          >
              ...
              <form className="mt-8 space-y-4">
                <div>
                  ...
                  <input
                    ...
                    id="name"
                    name="name"
                    className="w-full px-4 py-2 bg-slate-700/70 border border-slate-600/80 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white"
                    required
                ...
                <div>
                  ...
                  <textarea
                    ...
                    name="message"
                    rows={5}
                    className="w-full px-4 py-3 bg-slate-700/70 border border-slate-600/80 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white resize-none"
                    required
            ...
            >
              ...
              <div className="bg-gradient-to-br from-slate-800/90 to-slate-900/90 p-8 rounded-xl shadow-xl border border-slate-700/60">
                ...
                <p className="text-gray-300">I typically respond to all inquiries within 24 hours. Looking forward to connecting with you!</p>

                <div className="mt-6 pt-6 border-t border-slate-700 flex justify-between">
                  <div className="text-center">
                    <p className="text-blue-400 font-bold text-2xl">ML</p>
                    <p className="text-gray-400 text-sm">Projects</p>
                  </div>
                  <div className="text-center">
                    <p className="text-blue-400 font-bold text-2xl">24h</p>
